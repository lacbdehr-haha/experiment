...
from net import Led3Dnet_soft, FC, con_layer
...
from lock3d_dataloader import lock3d_trainloader
...
configurations1 = {
    1: dict(
        ...
        start_epoch=0,
        # lock3dface
        root_dir = '../data/lock3d/protocol/',
        train_list = '../data/lock3d/protocol/lock3d_data/',
        workers=8,
    )
}
...
def main():
    ...
    # load train data
    train_dataset = lock3d_trainloader(cfg['root_dir'], cfg['train_list'], transform_train)
