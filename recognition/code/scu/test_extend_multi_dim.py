...
import numpy as np
from scu_net import Led3Dnet_soft, con_layer
import argparse
...
def TestA(root_dir, backbone, gallery_file, nu_file, fe_file, ps1_file, ps2_file, flow, cond_layer):
    ...
    avg_acc = (nu_top1+fe_top1+ps1_top1+ps2_top1)/(nu_total+fe_total+ps1_total+ps2_total)
...
if __name__ == '__main__':
    list_dir = '../data/extend_multi_dim/protocol/file/'

    device = torch.device("cuda:0")
    gallery_A_file = list_dir + 'gallery.txt'
    nu_file = list_dir + 'probe_nu.txt'
    fe_file = list_dir + 'probe_fe.txt'
    ps1_file = list_dir + 'probe_ps1.txt'
    ps2_file = list_dir + 'probe_ps2.txt'
    ...
    for m in range(1, 51, 2):
        ...
        root_dir = '../data/extend_multi_dim/protocol/test_data/'
        TestA(root_dir, backbone, gallery_A_file, nu_file, fe_file, ps1_file, ps2_file, flow, cond_layer)