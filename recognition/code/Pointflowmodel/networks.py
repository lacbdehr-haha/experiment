...
# tensor、rt、- z.pow(2) / 2、logz - 3.0 * log_norm - (log_norm - mu).pow(2) / (2 * var)
from code.utils import truncated_normal, reduce_tensor, standard_normal_logprob, log_normal_logprob
