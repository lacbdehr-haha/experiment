# coding=utf-8
from .odefunc import ODEfunc, ODEnet, ODEHypernet, ODEhyperfunc
...
def get_latent_cnf(args):
    ...
    model = build_model(args, args.zdim, dims, args.context_dim, args.latent_num_blocks, True)
